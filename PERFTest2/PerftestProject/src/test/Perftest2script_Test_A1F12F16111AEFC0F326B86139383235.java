...
public class Perftest2script_Test_A1F12F16111AEFC0F326B86139383235 extends LTTestScript  {
...
private HTTPTestScriptHelper httpTestScriptHelper;
	...
	public Perftest2script_Test_A1F12F16111AEFC0F326B86139383235(IContainer container, String invocationId) {
		super(container, "Perftest2script", invocationId, "A1F12F16111AEFC0F326B86139383235", "/PerftestProject/Tests/Perftest2script.testsuite", "C:/Users/karthick_ba/WS1/PERFTest2/PerftestProject/Tests/Perftest2script.testsuite");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new HTTPPageTitleVPEvent(), new RPTContinueEvent("Page title verification failed"), 1, "Page title verification failed"));
	...
	this.add(page_4(this));
			this.httpTestScriptHelper.executeHelper();
		     ...
		     log("Test Execution: Perftest2script_Test_A1F12F16111AEFC0F326B86139383235 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1F12F16115ED690F326B86139383235");	
			vars[0] = new DataVar("Perftest2script_Host", "jpetstore.aspectran.com", IDataArea.TEST, "IGNORE", false, false);

	
		vars[1] = new DataVar("Perftest2script_Host_Port", "443", IDataArea.TEST, "IGNORE", false, false);
...
private HTTPPage page_1(final IContainer parent) {
			HTTPThink think = new HTTPThink(0, 1, parent, parent, "A1F12F16119F6207F326B86139383235");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "jpetstore.aspectran.com", "A1F12F16119F6207F326B86139383235") {
			...
			{ // Parallal Block Start
				...
				httpParallel.addRequest(0, request_1(this, true, "A1F12F16119CF100F326B86139383235", false, true,
						"Config_1", "/",	"/", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_2(this, false, "A1F12F16119CF100F326B86139383235", false, false,
						"Config_1", "speculation",	"/cdn-cgi/speculation", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(1, request_3(this, false, "A1F12F161214B910F326B86139383235", false, false,
						"Config_1", "logo-topbar.gif",	"/images/logo-topbar.gif", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_4(this, false, "A1F12F16119CF100F326B86139383235", false, false,
						"Config_1", "splash.gif",	"/images/splash.gif", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_5(this, false, "A1F12F16119CF100F326B86139383235", false, false,
						"Config_1", "FISH",	"/categories/FISH", true, false), 3478, 100, "A1F12F16121618A0F326B86139383235", 3);
				httpParallel.addRequest(0, request_6(this, false, "A1F12F16119CF100F326B86139383235", false, false,
						"Config_1", "FISH{1}",	"/categories/FISH", true, false), 178, 100, "A1F12F1612333D90F326B86139383235", 3);
			} // Parallal Block End 
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1611A44407F326B86139383235", getHTTPTest());
	...
	subContainer_1.addSubInstruction(sub_0);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1611A4E040F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1612138090F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_2.addSubInstruction(sub_2);
		...
		reqAction.addSemaphoreWait((IKAction)myPage.getActionMap().get("A1F12F1611A44407F326B86139383235"), 3);
		// wait on another action
		reqAction.addSemaphoreWait((IKAction)myPage.getActionMap().get("A1F12F1611A44407F326B86139383235"), 3);		
		IConnectionRecord serverConnection = ConnectionRecordFactory.find(parent, 
				parallelGroup, connConfigName,
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1612138093F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F161214B91EF326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_3.addSubInstruction(sub_4);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F161214B921F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F16121618A0F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_4.addSubInstruction(sub_6);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F16121618A3F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1612333D90F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_5.addSubInstruction(sub_8);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1612333D93F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1612347633F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_6.addSubInstruction(sub_10);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1612347636F326B86139383235",
			true,
			false
		);
...
private HTTPPage page_2(final IContainer parent) {
			HTTPThink think = new HTTPThink(18, 1, parent, parent, "A1F12F1612CC4940F326B86139383235");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "categories_DOGS", "A1F12F1612CC4940F326B86139383235") {
			...
			{ // Parallal Block Start
				...
				// httpParallel.addRequest(int serial, HTTPAction action, int actionDelay, String firstCharSemID) 
				httpParallel.addRequest(0, request_7(this, true, "A1F12F16119CF100F326B86139383235", false, false,
						"Config_1", "speculation{1}",	"/cdn-cgi/speculation", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_8(this, false, "A1F12F16119CF100F326B86139383235", false, false,
						"Config_1", "DOGS",	"/categories/DOGS", true, false), 3593, 100, "A1F12F1612CC4944F326B86139383235", 3);
				httpParallel.addRequest(0, request_9(this, false, "A1F12F16119CF100F326B86139383235", false, true,
						"Config_1", "DOGS{1}",	"/categories/DOGS", true, false), 148, 100, "A1F12F1612CD33D6F326B86139383235", 3);
			} // Parallal Block End 
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1612CC4944F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_7.addSubInstruction(sub_12);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1612CC4947F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1612CD33D6F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_8.addSubInstruction(sub_14);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1612CD33D9F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1612CE9337F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_9.addSubInstruction(sub_16);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1612CEBA41F326B86139383235",
			true,
			false
		);
...
private HTTPPage page_3(final IContainer parent) {
			HTTPThink think = new HTTPThink(26, 1, parent, parent, "A1F12F1613095240F326B86139383235");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "categories_REPTILES", "A1F12F1613095240F326B86139383235") {
			...
			{ // Parallal Block Start
				...
				// httpParallel.addRequest(int serial, HTTPAction action, int actionDelay, String firstCharSemID) 
				httpParallel.addRequest(0, request_10(this, true, "A1F12F16119CF100F326B86139383235", false, false,
						"Config_1", "speculation{2}",	"/cdn-cgi/speculation", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_11(this, false, "A1F12F16119CF100F326B86139383235", false, false,
						"Config_1", "REPTILES",	"/categories/REPTILES", true, false), 2528, 100, "A1F12F1613095244F326B86139383235", 3);
				httpParallel.addRequest(0, request_12(this, false, "A1F12F16119CF100F326B86139383235", true, true,
						"Config_1", "REPTILES{1}",	"/categories/REPTILES", true, false), 121, 100, "A1F12F16130AB1D0F326B86139383235", 3);
			} // Parallal Block End 
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1613095244F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_10.addSubInstruction(sub_18);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1613095247F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F16130AB1D0F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_11.addSubInstruction(sub_20);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F16130AB1D3F326B86139383235",
			true,
			false
		);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F1613197EE0F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_12.addSubInstruction(sub_22);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F1613197EE3F326B86139383235",
			true,
			false
		);
...
private HTTPPage page_4(final IContainer parent) {
			HTTPThink think = new HTTPThink(0, 1, parent, parent, "A1F12F16135109A0F326B86139383235");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "cdn-cgi_speculation", "A1F12F16135109A0F326B86139383235") {
			...
			{ // Parallal Block Start
				...
				// httpParallel.addRequest(int serial, HTTPAction action, int actionDelay, String firstCharSemID) 
				httpParallel.addRequest(0, request_13(this, true, "A1F12F161214B910F326B86139383235", true, true,
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1F12F16135109A4F326B86139383235", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	subContainer_13.addSubInstruction(sub_24);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1F12F16135109A7F326B86139383235",
			true,
			false
		);
